...
public class Ejercicio04{
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= paradas; i++) {
            ...
            paradas_ciudad = teclado.nextInt();
            ...
            if (c_origen == 1) {
                ...
                } else if (paradas_ciudad == 2) {
                    kilometros_recorridos = 39.8;
                } else if (paradas_ciudad == 3) {
                    kilometros_recorridos = 39.5;
                } else if (paradas_ciudad == 4) {
                    kilometros_recorridos = 68.9;
                } else if (paradas_ciudad == 5) {
                    kilometros_recorridos = 58.7;
                } else if (paradas_ciudad == 6) {
                    kilometros_recorridos = 24.1;
                } else if (paradas_ciudad == 7) {
                    kilometros_recorridos = 34.9;
                } else if (paradas_ciudad == 8) {
                    kilometros_recorridos = 88.1;
                } else if (paradas_ciudad == 9) {
                    kilometros_recorridos = 55.6;
                } else if (paradas_ciudad == 10) {
                    kilometros_recorridos = 65.7;
                } else if (paradas_ciudad == 11) {
                    kilometros_recorridos = 26.4;
                } else if (paradas_ciudad == 12) {
                    kilometros_recorridos = 77.4;
                } else if (paradas_ciudad == 13) {
                    kilometros_recorridos = 77.8;
                } else if (paradas_ciudad == 14) {
