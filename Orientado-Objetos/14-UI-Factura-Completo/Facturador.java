...
public class Facturador extends JFrame{
	...
	// Metodos
	public Facturador(Usuario [] listaUsuarios, Producto [] listaProductos){  // Todos los objetos NO visuales se inicializan en el constructor
        this.listaUsuarios = listaUsuarios;
        this.listaProductos = listaProductos;
        this.indiceItems = 0;
        this.totalFactura = 0;

		initComponent();  // Iniciar componentes visuales
	}

	public void initComponent(){     // Todos los objetos visuales en el init component
		...
		*/
        ...
        ActionListener evento_click_cliente = new ActionListener() {   // Buscar cliente
        ...
        KeyListener evento_key_cliente = new KeyListener(){   // EVENTO DE TECLADO
            ...
            public void keyReleased(KeyEvent e){
                ...
                //System.out.println("Tecla: "+e.getKeyCode());     // Codigo del teclado, por letra
                if(e.getKeyCode()==10){  // La tecla 10 corresponde al enter
                    buscarCliente();
                }
            }
        ...
        KeyListener evento_key_vendedor = new KeyListener(){   // EVENTO DE TECLADO
            public void keyPressed(KeyEvent e){
            }
    ...
    public void buscarCliente(){
        ...
        // Recorrer el arreglo y comparar la cedula
        for( int i = 0; i < listaUsuarios.length;i++){
            ...
            if(listaUsuarios[i] != null && listaUsuarios[i].getRol().equals("CLIENTE") && listaUsuarios[i].getCedula().equals(cedula)){
                ...
                input_cedula_vendedor.requestFocus();  // Enfoca el cursor en el input del vendedor
            }
        }
    }
