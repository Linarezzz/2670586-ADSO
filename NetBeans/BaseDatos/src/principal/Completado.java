...
public class Completado extends javax.swing.JFrame {
    ...
    public Completado(String texto) {
        this.texto = texto;
        initComponents();
    ...
    public void initAlternComponents(){
        ...
        setIconImage( getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_completado.png") ) );
        
        Image img_completado = getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_completado.png") );
        img_completado = img_completado.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
        etqImagen.setIcon(new ImageIcon(img_completado));
    ...
    private void initComponents() {
        ...
        btnCerrar.setBackground(new java.awt.Color(0, 204, 0));
