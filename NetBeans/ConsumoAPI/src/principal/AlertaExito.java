...
public class AlertaExito extends javax.swing.JFrame {

    String texto;
   
    public AlertaExito(String texto) {
        this.texto = texto;
        initComponents();
    ...
    public void initAlternComponents(){
        ...
        setIconImage( getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_exito.png") ) );
        
        Image img_warning = getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_exito.png") );
